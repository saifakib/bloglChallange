<aside id="leftsidebar" class="sidebar">
            ...
            <div class="user-info">
                <div class="image">
                    <img src="{{ Auth::User()->user_id == 1 ? Storage::disk('public')->url('profile/admin/'.Auth::user()->image) : 
                        Storage::disk('public')->url('profile/author/'.Auth::user()->image) }}"
