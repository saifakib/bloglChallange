...
@section('title','Admin Pending Post')
        ...
        <div class="container-fluid">
            ...
            <div class="row clearfix">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                        <div class="header">
                            <button style="font-size:20px"class="btn btn-success btn-lg btn-block waves-effect" type="button">PENDING POST <span class="badge">{{ $posts->count()}}</span></button>                          
                        </div>
                        <div class="body">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                    ...
                                                    <form id="approve-form-{{$post->id}}" action="{{ route('admin.post.approve', $post->id )}}"method="POST">
                                                        @csrf
                                                        @method('PUT')
                                                    </form>
    ...
    <script type="text/javascript">
        function approvePost(id)
        {
            ...
            swalWithBootstrapButtons.fire({
                title: 'Are you sure?',
                text: "You went to approve this post!"+id,
                type: 'warning',
